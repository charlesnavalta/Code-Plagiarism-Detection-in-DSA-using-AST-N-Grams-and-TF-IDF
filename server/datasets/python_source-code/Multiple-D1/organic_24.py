...
def split_segment_24(data_array, start_bound, end_bound):
...
def perform_quicksort_24(data_array, start_bound, end_bound):
    if start_bound < end_bound:
        split_loc = split_segment_24(data_array, start_bound, end_bound)
        perform_quicksort_24(data_array, start_bound, split_loc - 1)
        perform_quicksort_24(data_array, split_loc + 1, end_bound)

if __name__ == "__main__":
    sample_data = [18, 22, 14, 14, 28, 42]
    perform_quicksort_24(sample_data, 0, len(sample_data) - 1)
    print("Sorted #24:", sample_data)
