...
def split_segment_15(data_array, start_bound, end_bound):
...
def perform_quicksort_15(data_array, start_bound, end_bound):
    if start_bound < end_bound:
        split_loc = split_segment_15(data_array, start_bound, end_bound)
        perform_quicksort_15(data_array, start_bound, split_loc - 1)
        perform_quicksort_15(data_array, split_loc + 1, end_bound)

if __name__ == "__main__":
    sample_data = [5, 45, 15, 14, 28, 42]
    perform_quicksort_15(sample_data, 0, len(sample_data) - 1)
    print("Sorted #15:", sample_data)
