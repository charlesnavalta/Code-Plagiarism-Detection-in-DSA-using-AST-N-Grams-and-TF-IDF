...
if __name__=="__main__":
 bst = BinarySearchTree(); values = [50, 30, 70, 20, 40, 60, 80]



 for v in values: bst.root = bst.insert(bst.root, v)
 result = bst.search(bst.root, 60); print("Found" if result else "Not Found")